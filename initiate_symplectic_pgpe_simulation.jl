...
sim = gauss_quadrature_pgpe_simulation(64; g=0.01, sim_time=10000.0, sim_time_steps=100, special_mode_number=3, n0=1009, recurrence_ratio_criteria=0.97)
# (2) set initial state
...
fft_plot = plot_fourier_transform(freqs, amplitude, sim)
plot(E_N_err_plot, Eint_vs_Elin_plot, sim_plot, density_heatmap_plot,
    fft_plot, layout=(3, 2), size=(1300, 1000), simd=true)
